...
#define IOCTL_READ_KERNEL_MEM     0x1001
#define IOCTL_WRITE_KERNEL_MEM    0x1002
#define IOCTL_READ_PORT           0x1003
#define IOCTL_WRITE_PORT          0x1004
